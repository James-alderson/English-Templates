...
// Gulp default task
exports.default = series(parallel(css_task), cachebust_task, copyCss_task, copyImage_task, watch_task)

// Run browserSync
exports.bs = series(parallel(css_task), cachebust_task, copyCss_task, copyImage_task, browserSync, browserSyncWatch)
